...
async function main() {
  ...
  const doc = {
    _type: 'blogPost',
    _id: `blog-${slug}`,
    title: 'วิธีรักษาซึมเศร้าแบบธรรมชาติ ที่ได้ผลจริง — และเมื่อไหร่ควรพบผู้เชี่ยวชาญ',
    slug: { _type: 'slug', current: slug },
    category: 'สุขภาพใจ',
    excerpt:
      'ซึมเศร้ารักษาได้โดยไม่ต้องพึ่งยาเพียงอย่างเดียว รู้จักวิธีธรรมชาติที่พิสูจน์แล้วว่าได้ผล ทั้งการออกกำลังกาย โอเมก้า-3 และการนอนหลับ พร้อมเข้าใจว่าเมื่อไหร่ควรปรึกษาผู้เชี่ยวชาญที่ Thrive Bangkok',
    ...
    seo: {
      ...
      seoDescription:
        'ซึมเศร้ารักษาได้โดยไม่ต้องพึ่งยาเพียงอย่างเดียว รู้จักวิธีธรรมชาติที่พิสูจน์แล้วว่าได้ผล และเข้าใจว่าเมื่อไหร่ควรปรึกษาผู้เชี่ยวชาญที่ Thrive Bangkok',
      noIndex: false,
